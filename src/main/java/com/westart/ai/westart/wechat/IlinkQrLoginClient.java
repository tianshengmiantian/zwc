...
final class IlinkQrLoginClient {

    static final String LOGIN_BASE_URL = "https://ilinkai.weixin.qq.com";
    ...
    QrLoginStatus pollStatus(String baseUrl, String qrcode, String verifyCode) {
    ...
    static String redirectedBaseUrl(String redirectHost) {
    ...
    record QrCodeSession(String qrcode, String imageContent, String pollingBaseUrl) {
    }

    record QrLoginStatus(
            String status,
            String botToken,
            String userId,
            String botId,
